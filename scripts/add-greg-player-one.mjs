...
//   • gu-12 — "Nostalgia Series: Player One"  (24x36, $1,800)
//
// Run with:  node scripts/add-greg-player-one.mjs
...
const rows = [
  {
    id: "gu-12",
    title: "Nostalgia Series: Player One",
    artist: "Greg Urquhart",
    year: 2026,
    medium: "Resin on Wood Panel",
    dimensions: "24x36",
    sn: null,
    image: "/artists/greg_urquhart/player_one.jpeg",
    price: 180000,
    display_order: 56,
  },
];
