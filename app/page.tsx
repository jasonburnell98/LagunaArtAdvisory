  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Hover overlay — subtle darken to signal the image is clickable */}
        {!isSold && (
          <div className="absolute inset-0 bg-[#0a0a0a]/0 group-hover:bg-[#0a0a0a]/20 transition-all duration-500 pointer-events-none" />
        )}
      </div>
