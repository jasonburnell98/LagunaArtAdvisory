...
VALUES
  ...
  ('gu-10', 'Flock Mentality — Hot Pink Edition',    'Greg Urquhart', 2026, 'Resin on Wood Panel',         '16x20', NULL, '/artists/greg_urquhart/H_hot_pink_duck.jpeg',   50000, 54),
  ('gu-11', 'Flock Mentality — Black Edition',       'Greg Urquhart', 2026, 'Resin on Wood Panel',         '16x20', NULL, '/artists/greg_urquhart/I_black_duck.jpeg',      50000, 55)
ON CONFLICT (id) DO NOTHING;
